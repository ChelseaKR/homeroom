...
Every user-visible string exists in both languages: 219 keys per locale, zero
...
in `docs/audits/residual-risk-register.md`. What a person is meant to do, page
type by page type and in both languages, is written down in
`docs/accessibility-walkthrough.md`, whose results table is the record of it and
is empty.
